...
internal constructor(rxDispatcher: RxDispatcher, rxActionManager: RxActionManager, private val mGanApi: GanApi) : RxActionCreator(rxDispatcher, rxActionManager), RandomAction {
